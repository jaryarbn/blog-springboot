...
import com.github.jaryarbn.service.UserService;
...
class AuthControllerTest {
    ...
    void testLogin() throws Exception {
        ...
        Mockito.when(userService.getUserByUsername("MyUser")).thenReturn(new User(123, "MyUser", bCryptPasswordEncoder.encode("MyPassword")));
